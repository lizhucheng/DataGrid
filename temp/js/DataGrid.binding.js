...
cb.binding.DataGrid2Binding = function (mapping, parent) {
	
    cb.binding.BaseBinding.call(this, mapping, parent);
	//重写PropertyChangeEvent、get_method方法
	cb.binding.DataGrid2Binding.prototype.Model2UI = cb.binding.DataGrid2Binding.prototype.PropertyChangeEvent = function (evt) {
	...
	cb.binding.DataGrid2Binding.prototype.get_method = function (prefix, control, propertyName) {
...
cb.binding.DataGrid2Binding.prototype = new cb.binding.BaseBinding();
